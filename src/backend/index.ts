...
import { Cua, mcpTransport, type Toolbag } from '@backend/integrations/cua';
import { Mcp } from '@backend/integrations/mcp';
...
import { generate } from '@backend/providers/model-stream';
...
import { webfetchToolbag } from '@backend/tools/webfetch';
import { composeBuiltInToolbags, memoryToolbag } from '@backend/tools/memory';
import { LearningCoordinator, reviewWithModel } from '@backend/learning/learning';
